			...
			case *linebot.TextMessage:
				...
				if strings.Contains(message.Text, "/help") || strings.Contains(message.Text, "/HELP") {
					...
					*/
					...
					if strings.Contains(message.Text, "謝") || strings.Contains(strings.ToLower(message.Text), "thanks") || strings.Contains(strings.ToLower(message.Text), "thx") || strings.Contains(strings.ToLower(message.Text), "tks") {
